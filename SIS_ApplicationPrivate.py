...
# Robusten CSS za popolno vizualno prenovo stranske vrstice in gumba »
st.markdown("""
<style>
    ...
    /* Popravek odmikov v Streamlit expanderjih */
...
KNOWLEDGE_BASE = {
    ...
    "mental_structure": {
        "3-Level Platforms": "Philosophical (Science/Innovation), Everyday (Routine), Libidinal (Emotions/Desire).",
        "Info Hierarchy": "Cognitive building blocks: vocabulary, facts, principles, and concepts.",
        "Twelve Drives": "Fundamental needs, desires, and fears that regulate behaviors.",
        "Concentration Core": "Sustained focus acting as a filter, reinforced by ethical willpower.",
        "Mental Landscape": "Dynamic system where stimuli activate techniques via concentration."
    },
    "mental_approaches": {
        ...
        "Hierarchy and Associativity": "Social orientation mechanism vs Flexible unstructured ideation.",
        ...
        "Similarity and Difference": "Primary foundation for everyday cognition and classification.",
        "Compression and Condensation": "Optimization of physical and cognitive space management.",
        "Abstraction and Composition": "Removing irrelevant details or supplying missing elements.",
        "Mini–Max": "Scenario analysis optimization: minimizing loss, maximizing gain.",
        "Whole–Part Relations": "Examination of interrelations between components and the system whole.",
        "Perspective Shifting": "Examination from human, ground-level, or bird’s-eye perspectives.",
        "Openness and Closedness": "Degree of adaptability vs isolation and rigid isolation."
    },
    "subject_details": {
        "Physics": {"cat": "Natural", "col": "#264653", "meth": ["Simulation", "Modeling", "Calculus", "Spectroscopy"]},
        "Chemistry": {"cat": "Natural", "col": "#287271", "meth": ["Synthesis", "NMR", "Stoichiometry", "Chromatography"]},
        "Biology": {"cat": "Natural", "col": "#2a9d8f", "meth": ["CRISPR", "Sequencing", "Taxonomy", "Histology"]},
        "Neuroscience": {"cat": "Natural", "col": "#8ab17d", "meth": ["fMRI Imaging", "EEG", "Synaptic Mapping", "Tracing"]},
        "Psychology": {"cat": "Social", "col": "#b5ba72", "meth": ["Psychometrics", "Trials", "Cognitive Mapping", "Observation"]},
        "Sociology": {"cat": "Social", "col": "#e9c46a", "meth": ["Ethnography", "Surveys", "Network Analysis", "Statistics"]},
        "Economics": {"cat": "Social", "col": "#f4a261", "meth": ["Econometrics", "Game Theory", "Forecasting", "Audit"]},
        "Politics": {"cat": "Social", "col": "#e76f51", "meth": ["Policy Analysis", "Comparative Study", "Polling", "Diplomacy"]},
        "Computer Science": {"cat": "Formal", "col": "#d62828", "meth": ["Algorithms", "Verification", "Logic Parsing", "AI Training"]},
        "Medicine": {"cat": "Applied", "col": "#003049", "meth": ["Diagnostics", "Pharmacology", "Epidemiology", "Genetics"]},
        "Engineering": {"cat": "Applied", "col": "#669bbc", "meth": ["FEA Analysis", "Prototyping", "CAD Modeling", "Stress Test"]},
        "Library Science": {"cat": "Applied", "col": "#fdf0d5", "meth": ["Taxonomy", "Metadata Indexing", "Digital Archiving", "Curation"]},
        "Philosophy": {"cat": "Humanities", "col": "#c1121f", "meth": ["Dialectics", "Phenomenology", "Hermeneutics", "Logic"]},
        "Linguistics": {"cat": "Humanities", "col": "#780000", "meth": ["Corpus Analysis", "Syntactic Parsing", "Phonology", "Semantics"]},
        "Geography": {"cat": "Mixed", "col": "#003566", "meth": ["GIS Analysis", "Cartography", "Spatial Modeling", "Surveying"]},
        "Geology": {"cat": "Natural", "col": "#ffc300", "meth": ["Stratigraphy", "Mineralogy", "Seismology", "Petrology"]},
        "Climatology": {"cat": "Natural", "col": "#000814", "meth": ["Climate Modeling", "Paleoclimatology", "Meteorology", "Drilling"]},
        "History": {"cat": "Humanities", "col": "#ffd60a", "meth": ["Archival Research", "Chronology", "Historiography", "Paleography"]},
        "Music Science": {"cat": "Arts", "col": "#9b5de5", "meth": ["Harmonic Analysis", "Acoustics", "Ethnomusicology", "Spectral Analysis"]}
    },
...
with st.sidebar:
    ...
    api_key = st.text_input("Groq API Key:", type="password", help="Input your Groq key.")
    ...
    st.divider()
    # PRENOVLJENI GUMBI S SIMBOLOM »
    st.markdown('<a href="https://github.com/" target="_blank" class="sidebar-custom-link"><span>🌐 GitHub Repository</span> <span class="btn-arrow">»</span></a>', unsafe_allow_html=True)
    st.markdown('<a href="https://orcid.org/" target="_blank" class="sidebar-custom-link"><span>🆔 ORCID Registry</span> <span class="btn-arrow">»</span></a>', unsafe_allow_html=True)
    st.markdown('<a href="https://scholar.google.com/" target="_blank" class="sidebar-custom-link"><span>🎓 Google Scholar</span> <span class="btn-arrow">»</span></a>', unsafe_allow_html=True)
...
st.divider()
user_query = st.text_area("❓ Your Synthesis Inquiry:", placeholder="Synthesize the connection between harmonics and geopolitical forces.", height=150)
...
if st.button("🚀 Execute Multi-Dimensional Lego Synthesis", use_container_width=True):
    if not api_key: st.error("Missing Groq API Key.")
        ...
        try:
            ...
            2. Dissertation must be scholarly, multi-disciplinary, and structured (Introduction, Multi-disciplinary Synthesis, Conclusion).
