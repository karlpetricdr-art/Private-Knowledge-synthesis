...
# ==============================================================================
# 0. ADVANCED CONFIGURATION & INTERFACE STYLING (SIS LEGO UI)
# ==============================================================================
st.set_page_config(
...
# Robusten CSS za odpravo vizualnega kaosa in zagotovitev Lego simetrije
st.markdown("""
<style>
    ...
    /* Zamenjava collapse ikone s simbolom » */
    ...
    /* Odprava Streamlit razmikov v expanderjih */
...
# ==============================================================================
# 2. FULL MULTIDIMENSIONAL ONTOLOGY (19 DISCIPLINES & DETAILED MENTAL TOOLS)
# ==============================================================================
KNOWLEDGE_BASE = {
    "profiles": {
    ...
    "mental_approaches": {
        "Induction and Deduction": "Particular to general (Induction) vs Deduction (general premis to specific conclusion).",
        ...
        "Core, Attraction, Repulsion": "Principals underlying atomic structures and social models.",
    ...
    "subject_details": {
        ...
        "Neuroscience": {"cat": "Natural", "col": "#8ab17d", "meth": ["fMRI Imaging", "Synaptic Mapping"]},
        ...
        "Computer Science": {"cat": "Formal", "col": "#d62828", "meth": ["Algorithms", "Verification"]},
        ...
        "Music Science": {"cat": "Arts", "col": "#9b5de5", "meth": ["Harmonic Analysis", "Acoustics", "Transcription", "Spectral Analysis"]}
    },
...
# ==============================================================================
# 3. UI CONSTRUCTION (SIDEBAR & 9D KONFIGURACIJA)
# ==============================================================================
with st.sidebar:
    ...
    api_key = st.text_input("Groq API Key:", type="password", help="Groq key required for processing.")

    if st.button("📖 User Guide"):
        st.info("Set 9 dimensions, provide query, and execute synthesis. Graph nodes are interactive: click to scroll.")
...
st.divider()
user_query = st.text_area("❓ Your Synthesis Inquiry:", placeholder="Analyze the synergy between acoustic harmonics, music science and physics.", height=150)
...
if st.button("🚀 Execute Multi-Dimensional Lego Synthesis", use_container_width=True):
    if not api_key: st.error("Missing Groq API Key.")
        ...
        try:
            ...
            # SKRITA AKADEMSKA OPREDELITEV MENTALNIH PRISTOPOV ZA AI GLOBINO
            internal_logic = """
            - Induction: general concepts from particulars. Deduction: validating specific premises.
            - Bipolarity/Dialectics: dynamic interplay of opposites to reach innovative equilibrium.
            - Framework/Foundation: theories require stable yet flexible structures for application.
            - Hierarchy/Associativity: orienting mechanism vs flexible unstructured idea linking.
            - Pleasure/Displeasure: basic evaluative signal for solution quality and dialectical reasoning.
            - Core, Attraction, Repulsion: principle underlying atomic structure, planetary and social models.
            - Similarity/Difference: primary foundation for everyday assessment and classification systems.
            - Compression/Condensation: optimizing physical and cognitive space managing complexity.
            - Abstraction, Addition, and Composition: removing irrelevant details or supplying missing elements.
            - Mini–Max: scenario analysis optimization: minimizing potential losses, maximizing gains.
            - Whole–Part: examine interrelations between individual components and global integrity.
            - Perspective Shifting: Transitioning viewpoints from human-level to bird’s-eye views.
            - Openness/Closedness: Degree of system adaptability vs isolated rigidity.
            """

            sys_prompt = f"""
            You are the SIS Synthesizer. Perform an exhaustive academic dissertation (1500+ words).
            LEGO ARCHITECTURE ACTIVE:
            - INTERNAL LOGIC (Hidden): {internal_logic}
            ...
            STRICT RULES:
            1. Reasoning MUST be rooted in selected Mental Approaches and Subjects.
            2. Dissertation must be formal, scholarly, and structured.
